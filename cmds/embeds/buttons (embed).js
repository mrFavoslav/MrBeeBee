  ...
  async run({ message }) {
    ...
    const customEmbed = new Discord.MessageEmbed()
      ...
      .addFields(
        ...
        { name: '8a)', value: 'Je zakázáno jakkoliv zbytečně pingovat, či spamovat koholiv na tomto serveru (vztahuje se i do PM).', inline: true },
        ...
        { name: '10)', value: 'Je zakázáno spamovat a zahlcovat chat', inline: true },
        { name: '11)', value: 'Je zakázána PM reklama.', inline: true },
        { name: '12)', value: 'Je zakázáno rozesílat jakékoliv pornografické odkazy, lekací obrázky, nevhodné videa, gify apod. krom místností tomu vyhrazeným (pokud tu taková místnost bude)', inline: true },
        { name: '13)', value: 'Rasismus, homofóbie, nacismus, vnucování ideologií a podobné hovna jsou zakázány. (výjimkou jsou memes které mají účel pobavit)', inline: true },
    ...
    message.delete(1)
    client.channels.cache.get('934120866185375744').messages.fetch('1031133983259492423').then(msg => msg.edit({ embeds: [customEmbed], components: [row1] }))
  }
}